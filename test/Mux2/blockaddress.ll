...
; RUN: bcdb mux2 -uri sqlite:%t.bcdb prog -o %t-spurious --muxed-name=libmuxed.so --allow-spurious-exports

; RUN: bcdb mux2 -uri sqlite:%t.bcdb prog -o %t-open --muxed-name=libmuxed.so
