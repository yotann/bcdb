...
; RUN: bcdb add -store sqlite:%t.bcdb %p/Inputs/exported-once-and-directly-used.ll -name private
; RUN: bcdb gl -store sqlite:%t.bcdb prog private -o %t --merged-name=libmerged.so --weak-name=libweak.so --noplugin
