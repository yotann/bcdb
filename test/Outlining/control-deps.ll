...
; CHECK: head:
; CHECK-NEXT: block 2 depends [] forced [2, 3, 4, 5]
; CHECK-NEXT: node 3 depends [2] forced []
...
; CHECK-NEXT: node 5 depends [2, 3, 4] forced []
...
; CHECK-NEXT: node 7 depends [2, 3, 4, 5, 6] forced []
...
; CHECK: may_continue:
; CHECK-NEXT: block 2 depends [] forced [2, 3, 4, 5, 6, 7]
; CHECK-NEXT: node 3 depends [2] forced []
...
; CHECK: head:
; CHECK-NEXT: block 4 depends [2, 3] forced [3, 6, 7]
; CHECK-NEXT: node 5 depends [2, 3, 4] forced []
...
; CHECK-NEXT: node 7 depends [2, 3, 6] forced []
