...
; CHECK: node 2 data [1] dominating [0-1] forced [2-5]
; CHECK-NEXT: store volatile i32 4
  store volatile i32 4, i32* %1, align 4
; CHECK: node 3 data [1] dominating [0-2] forced [3-5]
; CHECK-NEXT: store volatile i32 8
  store volatile i32 8, i32* %1, align 4
; CHECK: node 4 data [1] dominating [0-3] forced [4-5]
...
; CHECK-NEXT: %a = alloca i32
  %a = alloca i32
; CHECK: node 2 dominating [0] forced [2-7]
; CHECK-NEXT: %b = alloca i32
  %b = alloca i32

; CHECK: node 3 data [1] dominating [0-1] forced [3-7]
; CHECK-NEXT: load volatile i32, i32* %a
  load volatile i32, i32* %a
; CHECK: node 4 data [2] dominating [0-3] forced [4-7]
; CHECK-NEXT: load i32, i32* %b
  load i32, i32* %b
; CHECK: node 5 data [1] dominating [0-1, 3] forced [5-7]
; CHECK-NEXT: load i32, i32* %a
  load i32, i32* %a

; CHECK: node 6 arg [0] dominating [0-5] forced [6-7]
; CHECK-NEXT: load volatile i32, i32* %arg1
  load volatile i32, i32* %arg1

; CHECK: node 7 arg [1] dominating [0-6]
